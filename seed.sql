...
-- Insert sample Flipkart products (using Unsplash images to bypass hotlink protection)
...
(
  ...
  ARRAY['https://images.unsplash.com/photo-1616348436168-de43ad0db179?w=500&q=80']
),
(
  'Samsung Galaxy M34 5G', 
  '120Hz sAMOLED Display, 50MP Triple No Shake Cam, 6000 mAh Battery.', 
  18999.00, 24999.00, 'Mobiles', 'Samsung', 50, 4.3, 12500, 
  ARRAY['https://images.unsplash.com/photo-1610945415295-d9bbf067e59c?w=500&q=80']
),
(
  'boAt Rockerz 450', 
  ...
  ARRAY['https://images.unsplash.com/photo-1618366712010-f4ae9c647dcb?w=500&q=80']
),
(
  'Nike Air Max 270', 
  ...
  ARRAY['https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=500&q=80']
),
(
  ...
  ARRAY['https://images.unsplash.com/photo-1542272604-787c3835535d?w=500&q=80']
),
(
  'LG 32 inch Smart TV', 
  'WebOS HD Ready Smart LED TV. Active HDR, WebOS Smart TV, Wi-Fi.', 
  22999.00, 32999.00, 'Appliances', 'LG', 15, 4.3, 5600, 
  ARRAY['https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?w=500&q=80']
),
(
  ...
  ARRAY['https://images.unsplash.com/photo-1585515320310-259814833e62?w=500&q=80']
),
(
  ...
  ARRAY['https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=500&q=80']
);